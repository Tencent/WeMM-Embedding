...
BREAKFAST_LABELS = [
    'pancake', 'cereal', 'sandwich', 'scrambledegg', 'friedegg', 'coffee', 'milk', 'tea', 'juice', 'salad']
K700_LABELS = [
    'waiting_in_line',
    'fly_tying',
    'breakdancing',
    ...
    'throwing_ball_(not_baseball_or_American_football)',
    'shooting_off_fireworks',
    'dunking_basketball',
    'making_a_cake',
    'chewing_gum',
    'front_raises',
...
DATASET_INSTRUCTION = {
    ...
    'HMDB51': 'What actions or objects interactions are the person in the video doing?\nQuestion: What actions or'
              ' objects interactions are the person in the video doing?',
